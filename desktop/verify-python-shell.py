...
if ('name="YuLawWorkbench"' not in spec or "console=False" not in spec
        or 'datas=[("data/tools.json", "data")]' not in spec):
    raise SystemExit("invalid Windows spec or missing packaged catalog")
